...
<head>
    ...
    <script>
        ...
        function toAddTeacher() {
            location.href = "/toAddTeacher";
        }

        function getBackAdminMain() {
...
<div class="box">
    ...
    <div class="body">
        <input type="button" value="返回主页面" onclick="getBackAdminMain()">
        ...
        <table>
            <tr>
                ...
                <td>创建时间</td>
                <td>操作
                    <input type="button" value="新增教师" onclick="toAddTeacher()">
                </td>
            </tr>
            <#list list as user>
                <tr>
